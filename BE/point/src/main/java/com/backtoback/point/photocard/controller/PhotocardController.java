...
import com.backtoback.point.photocard.dto.request.PhotocardInfoReq;
...
public class PhotocardController {
    ...
    @ApiOperation(value = "경기", notes = "경기 결과 받기")
...
//    public ResponseEntity<?> getPhotocard(@PathVariable("gameSeq") Long gameSeq,
//                                          @RequestBody PhotocardInfoReq photocardInfoReq) {
//        PhotocardResultRes response = photocardService.getPhotocard(gameSeq, photocardInfoReq);
